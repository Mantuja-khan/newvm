  ...
  head: () => ({
    meta: [
      { title: "VM Solutiions — Software, Cloud & IT Services in India" },
      {
        name: "description",
        content:
          "Web development, Tally & BUSY, cloud hosting and laptops — one trusted IT partner for your business.",
      },
    ],
  }),
  component: HomePage,
...
const WHY = [
  {
    ...
    text: "Expert solutions for Tally, BUSY and leading cloud vendors.",
  },
  {
    icon: FaLightbulb,
    title: "Solution First Thinking",
    text: "We solve business problems, not just deliver invoices.",
  },
  {
    icon: FaHandshake,
    title: "Long-term Partnership",
    text: "98% of our clients renew — because we obsess over outcomes.",
  },
];
const PROCESS = [
...
const TESTIMONIALS = [
  {
    ...
    text: "VM Solutiions migrated our entire billing to Tally Prime with zero downtime. Their team is a joy to work with.",
  },
  {
    name: "Priya Menon",
    role: "Founder, Verdant Retail",
    text: "Our new website converts 3x better and loads instantly. Best ROI decision we made this year.",
  },
  {
    name: "Aakash Kapoor",
    role: "CTO, LogiFast",
    text: "Their support team is proactive — we've had zero critical outages in 18 months. Absolutely recommended.",
  },
  {
    name: "Neha Gupta",
    role: "CEO, Bloom Studios",
    text: "Cloud hosting migration was seamless. Fast servers, great support and transparent pricing.",
  },
];
const FAQS = [
  {
    q: "Do you provide on-site support outside Delhi NCR?",
    a: "Yes. We offer on-site visits across major Indian locations and remote support pan-India, 24×7.",
  },
  {
    q: "Are refurbished laptops covered by warranty?",
    a: "All refurbished devices ship with a minimum 6-month warranty, extendable up to 24 months.",
  },
  {
    q: "Can you migrate my existing Tally data to a new system?",
    a: "Absolutely. Data migration, cleanup and validation are included in every setup engagement.",
  },
  {
    q: "Do you offer priority remote desktop support?",
    a: "Yes — emergency remote desktop assistance, routine health checks and software setup are included.",
  },
  {
    q: "Do you offer white-label web development?",
    a: "Yes — agencies and consultants can partner with us under NDA for white-label delivery.",
  },
];
function HomePage() {
  ...
  return (
    <>
      {/* HERO / TOP CTA */}
      <section
        className="reveal relative overflow-hidden bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: "url('/hero-cta-bg.png')" }}
      >
        ...
        <div className="absolute left-6 top-10 w-28 h-28 dot-pattern opacity-40 rounded-xl pointer-events-none -rotate-6" />
        <div className="absolute right-12 top-16 w-36 h-36 dot-pattern opacity-35 rounded-xl pointer-events-none rotate-12 hidden md:block" />
        <div className="absolute left-1/3 bottom-6 w-32 h-32 dot-pattern opacity-30 rounded-lg pointer-events-none rotate-3 hidden sm:block" />
        <div className="container-x relative pt-8 pb-16 md:pt-10 md:pb-24 grid lg:grid-cols-2 gap-12 items-center">
          <div key={active.slug} className="order-2 lg:order-1">
            <TextReveal
              as="span"
              triggerKey={`eyebrow-${active.slug}`}
              stagger={0.03}
              className="eyebrow text-xs sm:text-sm block"
            >
              — Welcome to VM Solutiions
            </TextReveal>
            <TextReveal
              as="h1"
              triggerKey={`title-${active.slug}`}
              delay={0.06}
              stagger={0.05}
              className="mt-4 text-2xl sm:text-4xl md:text-5xl lg:text-7xl font-bold leading-[1.05]"
            >
            ...
            <TextReveal
              as="p"
              triggerKey={`desc-${active.slug}`}
              delay={0.22}
              stagger={0.018}
              duration={0.4}
              className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg text-muted-foreground max-w-lg leading-relaxed"
            >
              {active.short}
            </TextReveal>
            <motion.div
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at 100% 0%, rgba(253, 224, 71, 0.25) 0%, rgba(253, 224, 71, 0.08) 40%, rgba(255,255,255,0) 70%)",
                filter: "blur(20px)",
              }}
            />
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, rgba(253, 224, 71, 0.35) 0%, rgba(255, 255, 255, 0.05) 60%, rgba(255, 255, 255, 0) 100%)",
      ...
      <section className="reveal py-20 md:py-24 bg-surface overflow-hidden">
        <div className="container-x">
          <SectionHeading
            ...
            title={
              <>
                High Quality <span className="text-primary">IT Services</span>
              </>
            }
            subtitle="Everything your business needs, from a single accountable partner."
          />
          <div className="mt-14">
            <Swiper
              modules={[Autoplay, Pagination]}
              ...
              {SERVICES.map((s) => (
                <SwiperSlide key={s.slug} className="h-auto">
                  <Link
                    to="/services/$slug"
                    params={{ slug: s.slug }}
                    className="group relative flex flex-col h-full bg-white rounded-2xl p-8 shadow-[var(--shadow-soft)] hover:shadow-[var(--shadow-card)] transition-all overflow-hidden"
                  >
        ...
        <div className="container-x grid lg:grid-cols-2 gap-14 items-center">
          ...
          >
            <img
              ...
              height={900}
              loading="lazy"
              alt="About VM Solutiions"
              className="rounded-2xl shadow-[var(--shadow-card)] object-cover w-full h-[420px]"
            />
          </motion.div>
          <div>
            <SectionHeading
              ...
              title={
                <>
                  We Provide Best Business <span className="text-primary">Solutions in Town</span>
                </>
              }
              subtitle="For over two decades, we've helped Indian businesses adopt the right technology at the right time — practical, reliable and honestly priced."
            />
            <ul className="mt-8 space-y-3">
              {[
                "24/7 On-site Services Available",
                "Great Skilled Consultants",
                "Expert Team Members",
      ...
      <section className="reveal py-24 bg-surface">
        <div className="container-x">
          <SectionHeading
            ...
            title={
              <>
                Reasons Businesses <span className="text-primary">Trust VM Solutiions</span>
              </>
            }
          />
          ...
          <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
            {PROCESS.map((p, i) => (
              <motion.div
                ...
                className="relative p-8 rounded-2xl bg-white shadow-[var(--shadow-soft)] hover:shadow-[var(--shadow-card)] transition-all"
              >
      ...
      <section className="reveal py-24 bg-surface overflow-hidden">
        <div className="container-x">
          <SectionHeading
            ...
            title={
              <>
                Featured <span className="text-primary">Website Projects</span>
              </>
            }
        ...
        <div className="container-x grid lg:grid-cols-[1fr_1.4fr] gap-14 items-start">
          <div className="lg:sticky lg:top-32">
            <SectionHeading
              ...
              subtitle="Can't find what you're looking for? Reach out — a human will reply within one business hour."
            />
  ...
  return (
    <div className="space-y-3">
      {FAQS.map((f, i) => (
        <div
          key={i}
          className={`rounded-2xl transition-all ${open === i ? "bg-white shadow-[var(--shadow-card)]" : "bg-white shadow-sm"}`}
        >
          <button
          ...
          >
            <span>{f.q}</span>
            <span
              className={`grid place-items-center h-8 w-8 rounded-full ${open === i ? "bg-primary text-white" : "bg-secondary text-primary"}`}
            >
