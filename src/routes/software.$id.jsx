...
function SoftwareDetailPage() {
    ...
    const isGroupedSpecs = product.specs &&
    ...
    return (<>
      ...
      <section className="py-12 bg-slate-50">
        <div className="container-x">
          <Link to="/software" className="inline-flex items-center gap-2 text-xs font-bold text-slate-600 hover:text-slate-900 transition-colors mb-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 md:p-8 grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 flex flex-col justify-between">
              <div>
                ...
                <div className="bg-white rounded-xl border border-slate-200/80 p-6 flex items-center justify-center relative min-h-[350px] shadow-inner">
                  <img src={activeImage} alt={product.name} className="max-h-[280px] w-auto object-contain transition-all duration-300"/>
            ...
            <div className="lg:col-span-7">
              ...
              {product.specs && (<div className="mt-8 border-t border-slate-200 pt-6">
            ...
            })) : (Object.entries(product.specs).map(([k, v]) => (<tr key={k} className="hover:bg-slate-50/50">
                              <td className="py-2.5 px-4 font-semibold text-slate-500 w-1/3 border-r border-slate-100 bg-slate-50/30">
                                {k}
                              </td>
                              <td className="py-2.5 px-4 text-slate-900 font-bold">
                      ...
                      <div>
                        ...
                        <Link to="/software/$id" params={{ id: rpId }}>
                          <div className="h-32 bg-white rounded-lg p-2 flex items-center justify-center">
                            {rp.image ? (<img src={rp.image} alt={rp.name} className="h-full w-auto object-contain"/>) : (<span className="text-xs text-slate-400">Genuine License</span>)}
                          </div>
            ...
            {quoteSubmitted ? (<div className="py-8 text-center">
                ...
                <div className="mt-4 space-y-3">
                  ...
                  <div>
                    ...
                    <textarea rows={2} value={message} onChange={(e) => setMessage(e.target.value)} placeholder="e.g. Need Tally on AWS cloud for 3 users..." className="mt-1 w-full px-3 py-2 border border-slate-200 rounded-xl text-xs"/>
                  </div>
                </div>
