...
import { PRODUCTS, Product, BRAND } from "@/data/site";
      ...
      <section className="reveal py-16 bg-slate-50/50">
        <div className="container-x">
          <SectionHeading
            ...
            title={<>Tally Prime, BUSY & <span className="text-primary">Tally on AWS Cloud</span></>}
            subtitle="Genuine accounting software licenses, user-based Tally-on-AWS cloud hosting plans, and BUSY software price matrix."
          />
                ...
                <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {filteredProducts.map((p) => {
                    ...
                    return (
                      <div
                        key={prodId}
                        className="group bg-white rounded-2xl border border-slate-200 p-5 shadow-[0_2px_12px_-3px_rgba(0,0,0,0.04)] hover:shadow-[0_12px_32px_-6px_rgba(0,0,0,0.08)] hover:border-emerald-500/40 transition-all flex flex-col justify-between cursor-pointer"
                      >
                        <div>
                          ...
                          <Link to="/software/$id" params={{ id: prodId }} className="block">
                            <div className="relative h-44 w-full bg-slate-50 rounded-xl overflow-hidden flex items-center justify-center p-4">
                              {p.image ? (
                                ...
                                <div className="text-slate-300 text-xs font-semibold">Genuine License</div>
                              )}
                        ...
                        <div className="mt-5 pt-4 border-t border-slate-100 flex items-center justify-between gap-2">
                          ...
                          <Link to="/software/$id" params={{ id: prodId }} className="block">
                            ...
                            <div className="flex items-baseline gap-2">
                              ...
                              {p.originalPrice && (
                                <span className="text-xs text-red-400 line-through">{p.originalPrice}</span>
                              )}
                            </div>
                          </Link>
