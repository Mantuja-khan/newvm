...
export function PageHero({ title, crumb }) {
  return (
    <section className="relative overflow-hidden bg-[image:var(--gradient-dark)] text-white">
      ...
      <div className="absolute top-6 left-10 w-24 h-24 dot-pattern-white opacity-25 border border-white/10 rounded-lg pointer-events-none -rotate-6" />
      <div className="absolute top-1/2 right-12 -translate-y-1/2 w-32 h-32 dot-pattern-white opacity-20 border border-white/10 rounded-xl pointer-events-none rotate-12 hidden sm:block" />
      <div className="absolute bottom-4 left-1/3 w-28 h-28 dot-pattern-white opacity-25 border border-white/10 rounded-lg pointer-events-none rotate-3" />
