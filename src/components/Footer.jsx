...
export function Footer() {
    return (<footer className="relative mt-24 text-white bg-[image:var(--gradient-dark)]">
      <div className="container-x pt-20 pb-10 grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
        <div>
          ...
          <div className="flex gap-3">
            {[FaFacebookF, FaTwitter, FaLinkedinIn, FaInstagram].map((Icon, i) => (<a key={i} href="#" aria-label="social" className="grid place-items-center h-9 w-9 rounded-full border border-white/20 hover:bg-primary hover:border-primary transition-colors">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/70">
            {SERVICES.slice(0, 5).map((s) => (<li key={s.slug}>
