...
export function ServiceReviews({ slug, serviceTitle }: { slug: string; serviceTitle: string }) {
        ...
        <div>
          ...
          {reviews.length === 0 ? (
            ...
            <div className="mt-6 space-y-4 max-h-[640px] overflow-y-auto pr-2">
              {reviews.map((r) => (
                <div key={r.id} className="bg-white rounded-2xl p-6 border border-border shadow-[var(--shadow-soft)] animate-fade-in">
