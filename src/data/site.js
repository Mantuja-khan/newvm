...
export const SERVICES = [
    ...
    benefits: [
      {
        ...
        text: "Layouts crafted around clear goals and measurable outcomes.",
      },
      {
        title: "Blazing Fast Loading",
        text: "Optimized assets, CDN delivery and Core Web Vitals scores.",
      },
      {
        title: "Scalable Architecture",
        text: "Codebases that grow with your business without rewrites.",
      },
    ],
  },
  {
    ...
    benefits: [
      {
        ...
        text: "Priority support channels and complete setup assistance.",
      },
      {
        title: "Faster Book Closure",
        text: "Streamlined workflows and automated reconciliations.",
      },
  ...
  },
  {
    ...
    benefits: [
      ...
      {
        title: "Indian & AWS Data Centers",
        text: "Low-latency hosting with data residency compliance.",
      },
