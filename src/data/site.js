...
import imgNiraajPack from "@/assets/niraaj_pack_website.png";
import imgGarvEnterprises from "@/assets/garv_enterprises.png";
import imgBombayDryCleaners from "@/assets/bombaywebsite.png";
import imgSunStar from "@/assets/sun_star_website.png";
import imgIasGroups from "@/assets/ias_group.png";
import imgTrivoxoToys from "@/assets/trivoxo_toys_website.png";
import imgSukohTech from "@/assets/sukoh_website.png";
import imgOjasPharma from "@/assets/ojas_pharma_website.png";
import imgJalvinderComputer from "@/assets/jalvinder_website.png";
import imgRengoAutomotives from "@/assets/rengo_website.png";
import imgDsEngg from "@/assets/ds-engg.png";
import imgShreeEnterprises from "@/assets/shree_enterprises_website.png";
import imgTallyLogo from "@/assets/tally-logo.png";
import protechnology from "@/assets/protechnology.png";
import prerna_vastu from "@/assets/prerna_vastu.png";
import aurevia_organics from "@/assets/aurevia_organic.png";
export const BRAND = {
    name: "VM Solutiions",
    full: "VM Solutiions",
...
export const SERVICES = [
    {
        ...
        image: imgWeb,
        description: "From marketing sites to full-scale web applications, we design and build fast, secure, SEO-friendly experiences that convert visitors into customers.",
        icon: FaLaptopCode,
        features: [
            "Custom UI/UX Design",
    ...
    },
    {
        ...
        description: "End-to-end accounting solutions — from licensing and installation to customization, GST compliance, migration and hands-on training for your team.",
        icon: FaCalculator,
        image: imgTallyLogo,
    ...
    },
    {
        ...
        description: "Enterprise-grade cloud infrastructure — hosted email, secure backups, high-availability VPS and fully-managed dedicated Tally on AWS servers with 99.9% uptime SLA.",
        icon: FaCloud,
        image: imgCloud,
        features: [
    ...
    },
    {
        ...
        description: "Quality-tested new and refurbished laptops and desktops from leading brands, backed by warranty, professional refurbishment and on-site service.",
        icon: FaLaptop,
        image: imgLaptop,
        features: [
    ...
    },
    {
        ...
        description: "Priority phone, chat and remote support with guaranteed response times — because your business can't wait.",
        icon: FaHeadset,
        features: [
...
export const CLIENT_PORTFOLIO = [
    ...
    {
        title: "Pro Technologies",
        category: "managed manufacturer of all types of Molds, including Injection molds, Die Casting molds, and Rubber Compression Molds",
        image: protechnology,
        url: "https://protechnology.in/",
    },
    {
        title: "Prerna Vastu",
        category: "Vastu Consulting & Spiritual Wellness",
        image: prerna_vastu,
        url: "https://prernavastu.com/",
    },
    {
        title: "Aurevia Organics",
        category: "organic products manufacturer",
        image: aurevia_organics,
        url: "https://aureviaorganicss.com/",
    },
];
